...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Simple Demo Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_GET, "sling.servlet.paths=" + "/bin/submitdata" })
public class SampleSlingPostServlet extends SlingAllMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		try {
			 ...
			 */
			Resource resource = resourceResolver.getResource("/content/firstpage");
			 ...
			 */
			Node newNode = node.addNode("sample-node", "nt:unstructured");
